...
// Example of `subject`: { packageName: 'govuk-frontend/govuk', item: '/all.js' }
...
//    {
//     nunjucksPaths: [
//      { packageName: 'govuk-frontend/govuk', item: '/' },
//      { packageName: 'govuk-frontend/govuk', item: '/components'}
//    ],
//    scripts: [
//      { packageName: 'govuk-frontend/govuk', item: '/all.js' }
//    ]
//    assets: [
//      { packageName: 'govuk-frontend/govuk', item: '/assets' }
//    ],
//    sass: [
//      { packageName: 'govuk-frontend/govuk', item: '/all.scss' }
//    ]}

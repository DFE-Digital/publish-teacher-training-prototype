...
exports.addCheckedFunction = function (env) {
  ...
  env.addGlobal('value', function (name) {
     if (this.ctx.data === undefined) {
       return ''
     }

     var value = this.ctx.data[name]
     if (value === undefined) {
       return ''
     }
   ...
   env.addGlobal('markdown', function(name) {
     if (this.ctx.data === undefined) {
       return ''
     }

     var text = this.ctx.data[name]
     if (text === undefined) {
       return ''
     }
   ...
   env.addGlobal('courseOptions', function() {
     var o = ['<option value=""></option>'];
     this.ctx.data['ucasCourses'].forEach(function(course) {
   ...
   env.addGlobal('error', function (id, errors) {
